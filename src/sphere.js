...
class Sphere {
    constructor(gl, radius = 1, sectors = 36, stacks = 18, smooth = true) {
        this.gl = gl;
        if (!gl) log("[WARNING] Sphere.contructor requires GL context as a param.");
    ...
    set(r, se, st, sm) {
        this.radius = r;
        this.sectorCount = se;
        if (se < 3) this.sectorCount = 3;
        this.stackCount = st;
        if (st < 2) this.stackCount = 2;
        this.smooth = sm;
        if (sm) this.buildVerticesSmooth();
        else this.buildVerticesFlat();
        return this;
    }
    setRadius(r) {
        if (this.radius != r) this.set(r, this.sectorCount, this.stackCount, this.smooth);
        return this;
    }
    setSectorCount(s) {
        if (this.sectorCount != s) this.set(this.radius, s, this.stackCount, this.smooth);
        return this;
    }
    setStackCount(s) {
        if (this.stackCount != s) this.set(this.radius, this.sectorCount, s, this.smooth);
        return this;
    }
    setSmooth(s) {
        if (this.smooth != s) {
            this.smooth = s;
            if (this.smooth) this.buildVerticesSmooth();
            else this.buildVerticesFlat();
        }
        return this;
    }
